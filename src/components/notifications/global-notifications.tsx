...
export function GlobalNotifications() {
  ...
  return <>
    <button className="global-notifications-trigger fixed bottom-[6.75rem] right-3 z-40 grid size-12 place-items-center rounded-full border border-white/80 bg-[#fffaf5]/95 text-[#c9687a] shadow-[0_8px_25px_rgba(114,75,66,.22)] backdrop-blur-xl transition active:scale-95 sm:bottom-[7.5rem] sm:right-6" type="button" onClick={() => setOpen(true)} aria-label={`Mở thông báo${unread ? `, ${unread} chưa đọc` : ""}`} title="Xem thông báo">
