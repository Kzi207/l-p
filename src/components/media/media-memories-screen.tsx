...
import { CalendarDays, Film, ImagePlus, Images, LoaderCircle, Play, Send, Upload, X } from "lucide-react";
  ...
  async function submit(event: FormEvent<HTMLFormElement>) {
    ...
    try {
      ...
      for (let index = 0; index < files.length; index += 1) {
        ...
        await addDoc(collection(db, "couples", coupleId, "mediaMemories"), {
