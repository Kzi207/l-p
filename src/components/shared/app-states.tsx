  ...
  return (
    <main className="flex min-h-dvh items-center justify-center px-5">
      <section className="soft-card max-w-lg p-8 text-center">
        ...
        <p className="mt-3 text-sm leading-6 text-[#806e65]">Sao chép <code>.env.local.example</code> thành <code>.env.local</code>, sau đó điền cấu hình Firebase, Neon và Cloudinary theo README.</p>
      </section>
    </main>
  );
}
